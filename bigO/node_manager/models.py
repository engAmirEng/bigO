...
class PublicIP(TimeStampedModel):
    ...
    isp = models.ForeignKey("proxy_manager.ISP", on_delete=models.PROTECT, related_name="isp_publicips", null=True, blank=True)
    region = models.ForeignKey("proxy_manager.Region", on_delete=models.PROTECT, related_name="region_publicips", null=True, blank=True)
