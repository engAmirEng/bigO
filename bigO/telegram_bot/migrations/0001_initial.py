    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("webhook_url_specifier", models.CharField(blank=True, db_index=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tlast_name", models.CharField(blank=True, max_length=255, null=True)),
                ("tusername", models.CharField(blank=True, max_length=255, null=True)),
                ("tlanguage_code", models.CharField(blank=True, max_length=3, null=True)),
                ("tis_premium", models.BooleanField(blank=True, null=True)),
                ("tadded_to_attachment_menu", models.BooleanField(blank=True, null=True)),
                (
                    "bot",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
