...
def get_subscription_profile_startlink(subscription_profile: proxy_manager_models.SubscriptionProfile, transfer_ownership: bool = False) -> str:
    ...
    key = set_secret_key(data={"subscription_profile_id": subscription_profile.id, "transfer_ownership": transfer_ownership}, length=10)
