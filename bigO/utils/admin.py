...
@overload
def admin_obj_change_url(*, obj: models.Model, obj_id: None = ..., obj_type: None = ...) -> str:
...
def admin_obj_change_url(
    obj: models.Model | None = None, obj_id: int | None = None, obj_type: type[models.Model] | None = None
):
    if obj:
